...
Revision ID: 7250eaf9f375
Revises: 
Create Date: 2025-03-12 02:22:21.987786
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_scoring_weights_id"), "scoring_weights", ["id"], unique=False
    )
    op.create_table(
        "user_activities",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "role", sa.Enum("ANALYST", "MANAGER", name="userrole"), nullable=False
        ),
        sa.Column("is_active", sa.Boolean(), nullable=True),
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column("market_cap", sa.JSON(), nullable=True),
        sa.Column("volume_24h", sa.JSON(), nullable=True),
        sa.Column("liquidity", sa.JSON(), nullable=True),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["scoring_weight_id"], ["scoring_weights.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
